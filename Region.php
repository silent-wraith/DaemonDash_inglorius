...
<div class="panel panel-default">
     ...
     <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Enter Location</a>
          
        </h4>
      </div>
      <div id="collapse2" class="panel-collapse collapse">
        <div class="panel-body"><ul class="list-group">
          <li class="list-group-item"><input type="radio" name="Location" value= "Northeast"> North East</input></li>
          <li class="list-group-item"><input type="radio" name="Location" value= "Midwest"> Mid West</input></li>
          <li class="list-group-item"><input type="radio" name="Location" value= "South"> South</input></li>
          <li class="list-group-item"><input type="radio" name="Location" value= "West"> West</input></li>
...
echo '<br><br><br>';
$query= "select U.uname as 'University Name',u.City,u.State,u.Website,u.UEmailID as 'E-Mail ID' from University U inner join Program P on u.UID=p.UID where u.uregion='".$loc."' and p.PCat='".$program."'" ;
...
echo "<tr><td><b>University Name</b></td><td><b>City</b></td><td><b>State</b></td></tr>";

while($row = sqlsrv_fetch_array($result))
{   //Creates a loop to loop through results
echo "<tr><td>" . $row['University Name'] . "</td><td>" . $row['City'] . "</td><td>" . $row['State'] . "</td></tr>";  //$row['index'] the index here is a field name

        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="light">
                    <p class="text-faded">View Non Profit Oranizations close to your locations and find out about volunteering opportunities.</p>
                </div>
                <div class="col-lg-3">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="light">
                    <p class="text-faded">We have explored Non Profit Organizatons predominantly working in tree domains</p>
      ...
      <aside class="bg-dark">
        <div class="container text-center">
            <div class="call-to-action">
                ...
                <a href="View_User_Profile.php" class="btn btn-default btn-xl sr-button">View Profile</a>
                <a href="Enroll_For_Activity.php" class="btn btn-default btn-xl sr-button">Enroll for activity</a>
            </div>
        </div>
      </aside>
...
VALUES ('11', '$name','$location', '$email','$interests','0')";

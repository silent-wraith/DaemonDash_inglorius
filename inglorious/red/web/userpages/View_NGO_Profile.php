...
<div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Enter NPO:</a>
 <?php
...
$sql=mysqli_query($conn,"SELECT Name FROM non_profit_organization");
...
$sql="Select p.Name,p.Domain,p.Location,p.Size,p.WebURL,p.Phone_No,p.Chairperson from non_profit_organization p where p.name='$name'";

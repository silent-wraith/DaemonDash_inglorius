...
<body>
  ...
  <div style = 'background-color: #23515c;color:#ffffff' class="jumbotron" align="center">
    ...
    <h1 > 
     Connect NGO to NGO at NGOConnect</h1>      
  </div>  
...
<div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Select User:</a>
 <?php
...
$sql=mysqli_query($conn,"SELECT Name FROM user");
...
echo "<tr><td><b>User_ID</b></td><td><b>Name</b></td><td><b>Location</b></td><td><b>E-Mail ID</b></td><td><b>Interests</b></td><td><b>Points_Balance</b></td></tr>";
...
echo "<tr><td>" . $row['User_ID'] . "</td><td>" . $row['Name'] ."</td><td>" . $row['Location'] ."</td><td>" . $row['E-Mail ID'] ."</td><td>" . $row['Interests'] ."</td><td>" . $row['Points_Balance']  ."</td></tr>";  //$row['index'] the index here is a field name

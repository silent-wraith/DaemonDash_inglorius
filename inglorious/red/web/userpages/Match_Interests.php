...
<body>
  ...
  <div style = 'background-color: #f78181;color:#fff' class="jumbotron" align="center">
    
    <h1 > 
     Connect NPO to Users at Non Profit Connect</h1>      
  </div>  
...
$sql=mysqli_query($conn,"SELECT distinct Domain FROM Activity");
